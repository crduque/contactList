			...
			<li className="list-group-item" key={index} id={eachContact.id}>
				<div className="row w-100">
					...
					<div className="col-12 col-sm-6 col-md-9 text-center text-sm-left">
						...
						<label className="name lead">{eachContact.full_name}</label>
						<br />
						<i className="fas fa-map-marker-alt text-muted mr-3" />
						<span className="text-muted">{eachContact.address}</span>
						<br />
						<span
						...
						/>
						<span className="text-muted small">{eachContact.phone}</span>
						<br />
						<span
							...
							title=""
						/>
						<span className="text-muted small text-truncate">{eachContact.email}</span>
					</div>
				</div>
			</li>
		);
